...
/* =========================================================================
* Function Name: Main
* Task: This React function based component will iterate through different
* routes (using the Switch component) and render the corresponding components.
*
...
* that the route should only match when the path name matches the route’s
* path exactly.
========================================================================= */
const Main = () => (
  <main>
